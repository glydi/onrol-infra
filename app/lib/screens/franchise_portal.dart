    ...
    return Scaffold(
      ...
      body: RefreshIndicator(onRefresh: _load, child: ListView(padding: EdgeInsets.fromLTRB(hp, 18, hp, 100), children: [
        ...
        if (_items.isEmpty) AppleCard(child: Text('No franchises yet. Add a partner — they get a login + branch dashboard.', style: AppleTheme.footnote(context)))
          ...
          Container(width: 40, height: 40, alignment: Alignment.center, decoration: BoxDecoration(color: AppleColors.teal.withOpacity(0.14), borderRadius: BorderRadius.circular(kRadiusField)), child: const Icon(CupertinoIcons.briefcase_fill, color: AppleColors.teal, size: 20)),
