                  ...
                  children: [
                    ...
                    RichText(
                      ...
                      text: TextSpan(children: [
                        TextSpan(text: 'ONROL ', style: GoogleFonts.ibmPlexMono(fontSize: 28, fontWeight: FontWeight.w800, color: label)),
                        TextSpan(text: 'Learn', style: GoogleFonts.ibmPlexMono(fontSize: 28, fontWeight: FontWeight.w800, color: _orange)),
                      ]),
                    ),
                    ...
                    Text(
                      ...
                      textAlign: TextAlign.center,
                      style: GoogleFonts.ibmPlexMono(fontSize: 14, color: grey),
                    ),
                    ...
                    if (_error != null) ...[
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(child: Text(_error!, style: GoogleFonts.ibmPlexMono(fontSize: 12.5, color: AppleColors.red))),
                        ],
                      ),
                    ],
                    if (!_forgot) ...[
                      ...
                      GestureDetector(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text('Remember me', style: GoogleFonts.ibmPlexMono(fontSize: 13, fontWeight: FontWeight.w600, color: label)),
                        ]),
                      ),
                    ],
                    const SizedBox(height: 22),
                    ...
                    if (!_forgot)
                      GestureDetector(
                        ...
                        child: Text('Forgot password?', textAlign: TextAlign.center, style: GoogleFonts.ibmPlexMono(fontSize: 13, fontWeight: FontWeight.w600, color: _orange)),
                      )
                    else
                      GestureDetector(
                        onTap: () => _toggleForgot(false),
                        child: Text('← Back to sign in', textAlign: TextAlign.center, style: GoogleFonts.ibmPlexMono(fontSize: 13, fontWeight: FontWeight.w600, color: _orange)),
                      ),
                    const SizedBox(height: 16),
                    if (!_forgot)
                      Text('Students, mentors and admins use the same sign-in.\nYour account decides what you see.',
                          textAlign: TextAlign.center, style: GoogleFonts.ibmPlexMono(fontSize: 12, color: grey, height: 1.5)),
                    const SizedBox(height: 22),
                    const ThemeToggle(),
                  ],
                ),
  ...
  Widget _primaryButton(String label, VoidCallback onTap) => GestureDetector(
        ...
        child: Container(
          ...
          child: _busy
              ...
              : Text(label, style: GoogleFonts.ibmPlexMono(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white)),
        ),
      );
}
